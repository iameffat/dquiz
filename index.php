...
<div class="minimal-hero-section">
    ...
    <div class="hero-content">
        <div class="container">
            ...
            <p class="lead">জ্ঞানার্জন ইবাদতের অংশ এবং প্রতিটি মুসলমানের জন্য ফরজ। তাই নিয়মিত দ্বীনিলাইফে আয়োজন হচ্ছে কুইজ প্রতিযোগিতা, যেখানে আপনি ইসলামের মৌলিক জ্ঞানকে যাচাই করতে পারবেন মজার এবং শিক্ষণীয় কুইজের মাধ্যমে।</p>
    ...
    <div class="row">
        <div class="col-md-8 mx-auto">
            <div class="quiz-rules-minimal">
                ...
                <p>১. প্রতিটি কুইজে অংশগ্রহণের জন্য লগইন/রেজিস্ট্রেশন সম্পন্ন করতে হবে।</p>
                ...
                <p>৫. ফলাফলের ভিত্তিতে র‍্যাংকিং নির্ধারিত হবে।</p>
            </div>
        </div>
    </div>
</div>
